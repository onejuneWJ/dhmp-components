...
public class NumberConvertUtil {
    ...
    private static final Log logger = LogFactory.getLog(NumberConvertUtil.class);
    ...
    public static Long convertToLongSafe(Object value, long defaultValue) {
        try {
            ...
            logger.warn(String.format("Error converting value to Long, fallback to default value %s", defaultValue));
            return defaultValue;
        }
    }
    ...
    public static Integer convertToIntegerSafe(Object value, int defaultValue) {
        try {
            ...
            logger.warn(String.format("Error converting value to Integer, fallback to default value %s", defaultValue));
            return defaultValue;
        }
    }
    ...
    public static Double convertToDoubleSafe(Object value, double defaultValue) {
        try {
            ...
            logger.warn(String.format("Error converting value to Double, fallback to default value %s", defaultValue));
            return defaultValue;
        }
    }
    ...
    public static Float convertToFloatSafe(Object value, float defaultValue) {
        try {
            ...
            logger.warn(String.format("Error converting value to Float, fallback to default value %s", defaultValue));
            return defaultValue;
        }
    }
