 ...
 * @author 王俊
 */
public class FileClient implements FileOperations, MessageSourceAware, InitializingBean {
    ...
    public FileClient(String basePath, FileInfoManager fileInfoManager) {
        this(basePath, fileInfoManager, false);
    }

    public FileClient(String basePath, FileInfoManager fileInfoManager, boolean remote) {
    ...
    public FileResponse getFile(String uid) {
        ...
        if (fileInfo == null) {
            return FileResponse.failed(null, this.messages.getMessage(FileErrorCode.FILE_INFO_NOT_FOUND, uid));
        }
        try {
    ...
    public static final class Builder {
        ...
        public FileClient build() {
            ...
            Assert.notNull(fileInfoManager, "fileInfoService cannot be null");
            return new FileClient(basePath, fileInfoManager);
        }
    }
